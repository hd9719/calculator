...
case 'fact':    number1=parseInt(display.value,10);
                number2 = factorial(number1); 
                display.value=number2;
                id1='fact' 
                break;
             
case 'root':    number1=parseInt(display.value,10);
                ...
                addtoHistory1(id1,number1,number2);
   }
...
if(expressions.length >= 10)
   {
               expressions.shift();
                ...
                expressions.push(expression);
                //to set expressions to localstorage with converting to  
                localStorage.setItem('expressions',JSON.stringify(expressions));
...
if(expressionLS==null)
     ...
     {          //to convert it to string parse it
